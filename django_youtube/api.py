...
class Api:
    ...
    def _access_control(self, access_control):
        """
    ...
    def update_video(self, video_id, title="", description="", keywords="", access_control=AccessControl.Public):
        """
        Updates the video
        ...
        # Set Access Control
        extension = self._access_control(AccessControl.Unlisted)
